...
**⌯ لمعرفة الاوامر اضغط على  » الاوامر !
⊱┉┉┉⊶𓄼•MUISC•𓄹⊷┉┉┉⊰
""",
    ...
    keyboard = InlineKeyboardMarkup(
            [
               [
                ...
                [       
                    InlineKeyboardButton(
                        "𓄼𝐒𝐄𝐋𝐕𝐀 𝐌𝐔𝐒𝐈𝐂 🎶𓄹", url=f"https://t.me/SO_SELVA"
                    ),
                ],
                [
                    InlineKeyboardButton("اضف البوت  لمجموعتك ➕", url=f"https://t.me/{BOT_USERNAME}?startgroup=true"),
...
async def help(client: Client, message: Message):
    await message.reply_photo(
        ...
        reply_markup=InlineKeyboardMarkup(
         [
            [
                InlineKeyboardButton("يب موجود 🙂❤️", url=f"http://t.me/{BOT_USERNAME}?start"),
            ],
            [
                InlineKeyboardButton(
...
@Client.on_message(command(["$", f"وامر", f"لاوامراغاني", f"لاوامر", f"اغاني", f"غاني"]) & filters.group & ~filters.edited)
    ...
    await message.reply_photo(
        ...
        reply_markup=InlineKeyboardMarkup(
         [
            ...
            [
                InlineKeyboardButton(
                    "⌯ MUISC 🎶 ⌯", url=f"https://t.me/I_donit_know_bot"
                ),
            ],
            [
                InlineKeyboardButton("اضف البوت  لمجموعتك ➕", url=f"https://t.me/{BOT_USERNAME}?startgroup=true"),
...
@Client.on_message(command(["uptime","بنك2", f"uptime@{BOT_USERNAME}"]) & ~filters.edited)
