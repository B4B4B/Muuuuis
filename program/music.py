    ...
    keyboard = InlineKeyboardMarkup(
        [
            [
              ...
              [InlineKeyboardButton("⌯ MUISC 🎶 ⌯", url=f"https://t.me/I_donit_know_bot"),
                ],
              [InlineKeyboardButton("⌯ اضافه البوت الى مجموعتك ⌯", url=f"https://t.me/{BOT_USERNAME}?startgroup=true"),              
            ]
        ]
    )
    if m.sender_chat:
